...
export function ProjectSection() {
  ...
  return (
    <section className="w-full max-w-none py-8 bg-white/80 bg-opacity-80 backdrop-blur-xl rounded-lg shadow-sm">
      ...
      {isLoading && !projects.length ? (
        ...
        /* Error state */
        <div className="bg-red-50 border border-red-200 rounded-lg p-4 mb-6 mx-8">
        ...
        /* Projects grid */
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4 w-full px-8">
